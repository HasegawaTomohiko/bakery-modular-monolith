 ...
 *
 * schemaFilter で catalog 以外を対象外にし、接続もモジュール専用ロールにしておく。
...
export default defineConfig({
  dialect: "postgresql",
  schema: "./src/modules/catalog/infra/db/schema.ts",
  out: "./src/modules/catalog/infra/db/migrations",
  schemaFilter: ["catalog"],
  dbCredentials: { url: moduleDatabaseUrl("catalog") },
});
