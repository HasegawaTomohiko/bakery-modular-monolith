 ...
 *
 * schemaFilter で production 以外を対象外にし、接続もモジュール専用ロールにしておく。
...
export default defineConfig({
  dialect: "postgresql",
  schema: "./src/modules/production/infra/db/schema.ts",
  out: "./src/modules/production/infra/db/migrations",
  schemaFilter: ["production"],
  dbCredentials: { url: moduleDatabaseUrl("production") },
});
