 ...
 *
 * schemaFilter で inventory 以外を対象外にし、接続もモジュール専用ロールにしておく。
...
export default defineConfig({
  dialect: "postgresql",
  schema: "./src/modules/inventory/infra/db/schema.ts",
  out: "./src/modules/inventory/infra/db/migrations",
  schemaFilter: ["inventory"],
  dbCredentials: { url: moduleDatabaseUrl("inventory") },
});
